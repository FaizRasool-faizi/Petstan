...
const mockPets: Pet[] = [
  {
    ...
    sellerLogo: '/sellers/seller1.png',
    ...
    images: ['/pets/golden-retriever.png'],
    age: '3 months',
  ...
  },
  {
    ...
    sellerLogo: '/sellers/seller2.png',
    name: 'Persian Cat',
    category: 'cats',
    breed: 'Persian',
    price: 35000,
  ...
  },
  {
    ...
    sellerLogo: '/sellers/seller3.png',
  ...
  },
  {
    ...
    images: ['/pets/german-shepherd.png'],
    age: '6 months',
    healthStatus: 'Excellent',
    gender: 'male',
    vaccinated: true,
  ...
  },
  {
    ...
    images: ['/pets/siamese-kitten.png'],
    age: '2 months',
    healthStatus: 'Excellent',
    gender: 'female',
    vaccinated: true,
  ...
  },
  {
    ...
    sellerLogo: '/sellers/seller4.png',
    name: 'Betta Fish',
    category: 'fish',
      ...
      <section className="py-12 bg-gradient-to-r from-rose-500 to-primary-600 text-white relative overflow-hidden">
        ...
        <div className="container-custom flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
           <div className="flex-1 space-y-3 text-center md:text-left">
             ...
             <p className="text-white/90 font-medium text-lg max-w-xl">Find your perfect companion today and get up to 50% off premium pets and free accessories!</p>
           </div>
           <FlashSaleTimer />
        </div>
      </section>
